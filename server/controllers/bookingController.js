...
// funct. to check availability of car for a given date
...
export const createBooking = async (req, res) => {
  try {
    ...
    if (!isAvailable) {
      return res.json({ success: false, message: "Car isn't available" });
    }
    ...
    res.json({ success: true, message: "Booking Create" });
  } catch (error) {
